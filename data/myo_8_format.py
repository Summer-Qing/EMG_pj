...
def MakeDir(number):
    if not os.path.exists("Action_Figure"):
        ...
        ### All_Channels ###
        ## Time_domain ##
        os.makedirs("EMG_QING_{}/All_Channels/Time_Domain/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/All_Channels/Time_Domain/Without_Axis".format(number))
        ## Spectrum ##
        os.makedirs("EMG_QING_{}/All_Channels/Spectrum/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/All_Channels/Spectrum/Without_Axis".format(number))
        ## Spectrogram ##
        os.makedirs("EMG_QING_{}/All_Channels/Spectrogram/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/All_Channels/Spectrogram/Without_Axis".format(number))
        ### Single_Channel_Single_Action ###
        ## Time_Domain ##
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Time_Domain/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Time_Domain/Without_Axis".format(number))
        ## Spectrum ##
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Spectrum/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Spectrum/Without_Axis".format(number))
        ## Spectrogram ##
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Spectrogram/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/Single_Channel_Single_Action/Spectrogram/Without_Axis".format(number))
        ### Nine_spectrograms_In_One ###
        ## Average ##
        os.makedirs("EMG_QING_{}/Nine_In_One/Average/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/Nine_In_One/Average/Without_Axis".format(number))
        ## Max ##
        os.makedirs("EMG_QING_{}/Nine_In_One/Max/With_Axis".format(number))
        os.makedirs("EMG_QING_{}/Nine_In_One/Max/Without_Axis".format(number))
        # ## Spectrum ##
...
######## 绘制每个通道的图<含时域、频域、语谱> ########
def AllChannels(axis, figcate, time,Fs, emg_signal,nfft, noverlap, number):
    if figcate == 0:    ### time_domain ###
        if axis == 1:    ### 有轴 ###
            for j in range(len(emg_signal)):
                ...
                plt.savefig("EMG_QING_{}/All_Channels/Time_Domain/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
                plt.close()
        elif axis == 0:   ### 无轴 ###
            for j in range(len(emg_signal)):
                plt.figure("Channel-%d" % (j + 1))
                ...
                plt.axis('off')
                photo_name = "Channel_%d.png" % (j + 1)
                plt.savefig("EMG_QING_{}/All_Channels/Time_Domain/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
                plt.close()
    elif figcate == 1: ### 频域图 ###
        if axis == 1:   ### 有轴 ###
            for j in range(len(emg_signal)):
                ...
                photo_name = "Channel_%d.png" % (j + 1)
                plt.savefig("EMG_QING_{}/All_Channels/Spectrum/With_Axis/{}".format(number, photo_name), bbox_inches='tight')
                plt.close()
        elif axis == 0:   ### 无轴 ###
            for j in range(len(emg_signal)):
                plt.figure("Channel-%d" % (j + 1))
                ...
                plt.axis('off')
                photo_name = "Channel_%d.png" % (j + 1)
                plt.savefig("EMG_QING_{}/All_Channels/Spectrum/Without_Axis/{}".format(number, photo_name), bbox_inches='tight')
                plt.close()
    elif figcate == 2:
        if axis == 1:  ### 有轴 ###
            for j in range(len(emg_signal)):
                ...
                photo_name = "Channel_%d.png" % (j + 1)
                plt.savefig("EMG_QING_{}/All_Channels/Spectrogram/With_Axis/{}".format(number, photo_name), bbox_inches='tight')
                plt.close()
        elif axis == 0:  ### 无轴 ###
            for j in range(len(emg_signal)):
                plt.figure("Channel-%d" % (j + 1))
                ...
                plt.axis('off')
                photo_name = "Channel_%d.png" % (j + 1)
                plt.savefig("EMG_QING_{}/All_Channels/Spectrogram/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
                plt.close()

######## 绘制每个通道每个动作的图<含时域、频域、语谱> ########
def Single_Channel_Single_Action(axis, figcate, action, num, t, time,Fs, emg_signal,nfft, noverlap, number):
    if figcate == 0:    ### 时域图 ###
        if axis == 1:    ### 有轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Time_Domain/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()
        elif axis == 0:   ### 无轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    plt.axis('off')
                    photo_name = "%s-%d-%d-%d.png" % (action[i], j + 1, num, t)
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Time_Domain/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()
    elif figcate == 1: ### 频域图 ###
        if axis == 1:   ### 有轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    photo_name = "%s-%d-%d-%d.png" % (action[i], j + 1, num, t)
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Spectrum/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()
        elif axis == 0:   ### 无轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    plt.axis('off')
                    photo_name = "%s-%d-%d-%d.png" % (action[i], j + 1, num, t)
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Spectrum/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()
    elif figcate == 2:
        if axis == 1:  ### 有轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    photo_name = "%s-%d-%d-%d.png" % (action[i], j + 1, num, t)
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Spectrogram/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()
        elif axis == 0:  ### 无轴 ###
            for j in range(len(emg_signal)):
                for i in range(len(emg_signal[j])):
                    ...
                    plt.axis('off')
                    photo_name = "%s-%d-%d-%d.png" % (action[i], j + 1, num, t)
                    plt.savefig("EMG_QING_{}/Single_Channel_Single_Action/Spectrogram/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
                    plt.close()

######## 一共九张图在一个figure上 <含语谱> ########
def Nine_In_One_Ave(axis, action, num, t, Fs, emg_signal,nfft, noverlap, number):
    ...
    if axis == 1:
        for i in range(len(emg_temp)):
            ...
            plt.savefig("EMG_QING_{}/Nine_In_One/Average/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
            plt.close()
    elif axis == 0:
        for i in range(len(emg_temp)):
            fig, axes = plt.subplots(nrows=3, ncols=3, figsize=(13.6, 8))
            for j in range(len(emg_temp[i])-1):
                ...
                plt.axis('off')
            photo_name = "%s-%d-%d.png" % (action[i], num, t)
            plt.savefig("EMG_QING_{}/Nine_In_One/Average/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
            plt.close()

def Nine_In_One_Max(axis, action, num, t, Fs, emg_signal, nfft, noverlap, number):
    emg_temp = trans(emg_signal)
    if axis == 1:
        for i in range(len(emg_temp)):
            fig, axes = plt.subplots(nrows=3, ncols=3, figsize=(13.6, 8))
            for j in range(len(emg_temp[i])):
                if j == 8:
                    ...
                    Spectrogram(nfft, noverlap, Fs, emg_temp[i][j])
            photo_name = "%s-%d-%d.png" % (action[i], num, t)
            plt.savefig("EMG_QING_{}/Nine_In_One/Max/With_Axis/{}".format(number, photo_name),bbox_inches='tight')
            plt.close()
    elif axis == 0:
        for i in range(len(emg_temp)):
            fig, axes = plt.subplots(nrows=3, ncols=3, figsize=(13.6, 8))
            for j in range(len(emg_temp[i])):
                if j == 8:
                    ...
                    plt.axis('off')
            photo_name = "%s-%d-%d.png" % (action[i], num, t)
            plt.savefig("EMG_QING_{}/Nine_In_One/Max/Without_Axis/{}".format(number, photo_name),bbox_inches='tight')
            plt.close()
...
def run(number):
    ...
    ##emg_qing_21.csv
    lrange21 = [1150, 3380, 5450, 7500, 9550, 11650, 13650,
              15500, 17350, 19250]
    rrange21 = [2200, 4500, 6400, 8400, 10550, 12500, 14400,
              16300, 18150, 20300]

    ##emg_qing_22.csv
    lrange22 = [1100, 3280, 5350, 7400, 9450, 11550, 13600,
              15450, 17250, 19250]
    rrange22 = [2100, 4400, 6400, 8350, 10600, 12600, 14500,
              16350, 18120, 20250]

    ##emg_qing_23.csv
    lrange23 = [1130, 3280, 5380, 7400, 9450, 11550, 13600,
              15450, 17250, 19250]
    rrange23 = [2100, 4400, 6400, 8350, 10600, 12600, 14500,
              16380, 18220, 20420]

    ##emg_qing_24.csv
    lrange24 = [1130, 3300, 5420, 7420, 9450, 11650, 13600,
              15450, 17250, 19300]
    rrange24 = [2250, 4500, 6350, 8400, 10650, 12550, 14400,
              16430, 18220, 20320]

    ##emg_qing_25.csv
    lrange25 = [1130, 3300, 5420, 7420, 9450, 11650, 13600,
              15450, 17250, 19250]
    rrange25 = [2100, 4300, 6400, 8400, 10680, 12500, 14450,
              16400, 18220, 20280]

    ##emg_qing_26.csv
    lrange26 = [1180, 3400, 5470, 7520, 9450, 11650, 13650,
              15500, 17300, 19250]
    rrange26 = [2200, 4400, 6400, 8400, 10680, 12600, 14450,
              16400, 18250, 20280]

    ##emg_qing_27.csv
    lrange27 = [1180, 3400, 5470, 7520, 9450, 11650, 13650,
              15500, 17300, 19250]
    rrange27 = [2200, 4400, 6400, 8400, 10680, 12500, 14450,
              16440, 18150, 20380]

    ##emg_qing_28.csv
    lrange28 = [1180, 3300, 5440, 7420, 9450, 11650, 13650,
              15500, 17300, 19250]
    rrange28 = [2200, 4400, 6350, 8450, 10680, 12500, 14450,
              16400, 18050, 20280]


    ##emg_qing_29.csv
    lrange29 = [1250, 3400, 5490, 7480, 9520, 11700, 13650,
              15550, 17350, 19350]
    rrange29 = [2200, 4450, 6400, 8450, 10680, 12550, 14500,
              16450, 18100, 20330]

    ##emg_qing_30.csv
    lrange30 = [1150, 3400, 5440, 7480, 9500, 11600, 13650,
              15450, 17250, 19200]
    rrange30 = [2150, 4400, 6400, 8400, 10630, 12450, 14500,
              16400, 18150, 20330]

    ##emg_qing_31.csv
    lrange31 = [1100, 3350, 5380, 7430, 9450, 11600, 13650,
              15450, 17250, 19300]
    rrange31 = [2100, 4450, 6400, 8400, 10630, 12450, 14500,
              16550, 18150, 20330]

    ##emg_qing_32.csv
    lrange32 = [1250, 3450, 5480, 7500, 9650, 11700, 13650,
              15700, 17350, 19400]
    rrange32 = [2150, 4350, 6500, 8500, 10730, 12550, 14550,
              16450, 18250, 20380]

    ##emg_qing_33.csv  Broken data
    lrange33 = [1200, 3350, 5450, 7450, 9550, 11650, 13600,
              15450, 17300, 19250]
    rrange33 = [2200, 4450, 6450, 8450, 10600, 12600, 14600,
              16600, 18250, 20350]

    ##emg_qing_34.csv  Broken data
    lrange34 = [1200, 3350, 5450, 7450, 9500, 11650, 13600,
              15500, 17300, 19300]
    rrange34 = [2150, 4400, 6450, 8450, 10600, 12600, 14600,
              16500, 18250, 20450]

    ##emg_qing_35.csv  Broken data
    lrange35 = [1200, 3350, 5450, 7450, 9500, 11650, 13600,
              15500, 17300, 19250]
    rrange35 = [2050, 4350, 6400, 8450, 10600, 12600, 14500,
              16400, 18250, 20350]

    ##emg_qing_36.csv  Broken data
    lrange36 = [1250, 3350, 5450, 7450, 9500, 11650, 13660,
              15550, 17300, 19400]
    rrange36 = [2150, 4400, 6450, 8450, 10650, 12600, 14600,
              16450, 18250, 20350]

    ##emg_qing_37.csv  Broken data
    lrange37 = [1200, 3350, 5450, 7550, 9550, 11750, 13700,
              15550, 17350, 19300]
    rrange37 = [2150, 4500, 6450, 8450, 10750, 12600, 14600,
              16500, 18250, 20450]

    ##emg_qing_38.csv  Broken data
    lrange38 = [1200, 3350, 5450, 7450, 9500, 11600, 13600,
              15500, 17300, 19300]
    rrange38 = [2150, 4400, 6450, 8450, 10600, 12600, 14550,
              16500, 18250, 20450]

    ##emg_qing_39.csv  Broken data
    lrange39 = [1100, 3350, 5450, 7450, 9500, 11600, 13600,
              15500, 17250, 19300]
    rrange39 = [2150, 4400, 6450, 8450, 10600, 12500, 14550,
              16400, 18150, 20250]

    ##emg_qing_40.csv  Broken data
    lrange40 = [1150, 3350, 5450, 7450, 9450, 11600, 13600,
              15500, 17200, 19300]
    rrange40 = [2100, 4350, 6450, 8450, 10650, 12550, 14500,
              16400, 18200, 20350]

    ##emg_qing_41.csv  Broken data
    lrange41 = [1100, 3350, 5350, 7400, 9500, 11600, 13600,
              15500, 17300, 19250]
    rrange41 = [2150, 4400, 6350, 8450, 10600, 12550, 14500,
              16500, 18200, 20250]

    ##emg_qing_42.csv  Broken data
    lrange42 = [1300, 3550, 5550, 7600, 9600, 11700, 13800,
              15700, 17450, 19450]
    rrange42 = [2250, 4600, 6550, 8550, 10900, 12650, 14600,
              16600, 18450, 20550]

    ##emg_qing_43.csv  Broken data
    lrange43 = [1100, 3350, 5350, 7400, 9500, 11600, 13600,
              15500, 17300, 19250]
    rrange43 = [2150, 4400, 6350, 8250, 10700, 12550, 14500,
              16500, 18150, 20350]

    ##emg_qing_44.csv  Broken data
    lrange44 = [1200, 3350, 5350, 7400, 9500, 11600, 13600,
              15500, 17400, 19250]
    rrange44 = [2150, 4400, 6450, 8450, 10600, 12550, 14500,
              16400, 18200, 20450]

    ##emg_qing_45.csv  Broken data
    lrange45 = [1200, 3350, 5400, 7400, 9600, 11600, 13600,
              15500, 17200, 19250]
    rrange45 = [2100, 4400, 6450, 8450, 10650, 12500, 14500,
              16450, 18300, 20350]

    ##emg_qing_46.csv  Broken data
    lrange46 = [1150, 3350, 5350, 7400, 9500, 11600, 13600,
              15500, 17300, 19250]
    rrange46 = [2150, 4400, 6350, 8450, 10650, 12450, 14500,
              16400, 18200, 20450]

    ##emg_qing_47.csv  Broken data
    lrange47 = [1500, 3850, 5850, 7900, 10000, 12100, 14100,
              15900, 17700, 19650]
    rrange47 = [2600, 4800, 6750, 8750, 11100, 12950, 14900,
              16800, 18700, 20700]

    ##emg_qing_48.csv  Broken data
    lrange48 = [1200, 3400, 5450, 7450, 9500, 11600, 13650,
              15500, 17300, 19450]
    rrange48 = [2150, 4400, 6450, 8450, 10600, 12550, 14550,
              16450, 18400, 20450]

    ##emg_qing_49.csv  Broken data
    lrange49 = [1200, 3350, 5450, 7500, 9500, 11600, 13650,
              15500, 17300, 19450]
    rrange49 = [2150, 4500, 6500, 8450, 10700, 12550, 14550,
              16400, 18250, 20350]

    ##emg_qing_50.csv  Broken data
    lrange50 = [1200, 3350, 5450, 7400, 9500, 11600, 13600,
              15500, 17300, 19250]
    rrange50 = [2150, 4400, 6400, 8450, 10650, 12550, 14500,
              16400, 18150, 20350]

    ##emg_qing_51.csv  Broken data
    lrange51 = [1100, 3350, 5400, 7400, 9450, 11600, 13600,
              15500, 17300, 19250]
    rrange51 = [2100, 4400, 6400, 8450, 10600, 12450, 14450,
              16400, 18200, 20300]

    ##emg_qing_52.csv  Broken data
    lrange52 = [1250, 3350, 5400, 7400, 9500, 11600, 13600,
              15500, 17350, 19250]
    rrange52 = [2200, 4400, 6450, 8450, 10600, 12550, 14500,
              16400, 18200, 20300]

    ##emg_qing_53.csv  Broken data
    lrange53 = [1700, 3850, 5850, 7900, 10000, 12100, 14200,
              16050, 17750, 19750]
    rrange53 = [2600, 5000, 6950, 8950, 11200, 13050, 15050,
              16900, 18750, 20950]

    ##emg_qing_54.csv  Broken data
    lrange54 = [1050, 3350, 5300, 7400, 9600, 11600, 13600,
              15500, 17250, 19250]
    rrange54 = [2150, 4400, 6450, 8450, 10600, 12550, 14400,
              16400, 18250, 20300]

    ##emg_qing_55.csv  Broken data
    lrange55 = [1250, 3350, 5450, 7500, 9500, 11650, 13650,
              15500, 17350, 19250]
    rrange55 = [2200, 4500, 6450, 8450, 10600, 12550, 14500,
              16400, 18200, 20300]

    ##emg_qing_56.csv  Broken data
    lrange56 = [1150, 3350, 5400, 7450, 9500, 11600, 13600,
              15500, 17350, 19300]
    rrange56 = [2100, 4400, 6450, 8400, 10600, 12350, 14500,
              16300, 18200, 20300]

    ##emg_qing_57.csv  Broken data
    lrange57 = [1200, 3350, 5400, 7450, 9500, 11600, 13650,
              15500, 17350, 19250]
    rrange57 = [2200, 4400, 6450, 8450, 10600, 12550, 14600,
              16400, 18250, 20300]

    ##emg_qing_58.csv  Broken data
    lrange58 = [1250, 3450, 5500, 7600, 9600, 11750, 13800,
              15600, 17400, 19300]
    rrange58 = [2200, 4600, 6550, 8550, 10800, 12550, 14750,
              16600, 18350, 20450]

    ##emg_qing_59.csv  Broken data
    lrange59 = [1250, 3350, 5500, 7500, 9600, 11650, 13650,
              15550, 17350, 19350]
    rrange59 = [2200, 4400, 6450, 8450, 10600, 12550, 14500,
              16400, 18300, 20350]

    ##emg_qing_60.csv  Broken data
    lrange60 = [1150, 3350, 5450, 7400, 9450, 11600, 13600,
              15500, 17250, 19250]
    rrange60 = [2100, 4400, 6350, 8450, 10600, 12550, 14500,
              16400, 18200, 20300]

    ##emg_qing_61.csv  Broken data
    lrange61 = [1250, 3350, 5400, 7450, 9500, 11600, 13600,
              15500, 17350, 19450]
    rrange61 = [2200, 4400, 6450, 8450, 10650, 12550, 14500,
              16450, 18250, 20400]

    ##emg_qing_62.csv  Broken data
    lrange62 = [1250, 3450, 5400, 7500, 9500, 11700, 13700,
              15600, 17350, 19350]
    rrange62 = [2200, 4400, 6450, 8400, 10650, 12550, 14600,
              16450, 18300, 20400]

    ##emg_qing_63.csv  Broken data
    lrange63 = [1250, 3450, 5400, 7500, 9550, 11600, 13650,
              15500, 17250, 19350]
    rrange63 = [2200, 4400, 6450, 8400, 10650, 12550, 14600,
              16450, 18200, 20350]

    ##emg_qing_64.csv  Broken data
    lrange64 = [1200, 3400, 5450, 7500, 9500, 11700, 13800,
              15500, 17350, 19400]
    rrange64 = [2150, 4400, 6400, 8400, 10650, 12550, 14600,
              16350, 18200, 20400]

    ##emg_qing_65.csv  Broken data
    lrange65 = [1450, 3450, 5500, 7500, 9600, 11700, 13600,
              15600, 17550, 19350]
    rrange65 = [2200, 4500, 6450, 8450, 10750, 12550, 14600,
              16500, 18450, 20450]

    ##emg_qing_66.csv  Broken data
    lrange66 = [1150, 3450, 5400, 7450, 9500, 11650, 13650,
              15500, 17250, 19300]
    rrange66 = [2150, 4400, 6400, 8450, 10650, 12550, 14550,
              16350, 18200, 20300]

    ##emg_qing_67.csv  Broken data
    lrange67 = [1150, 3350, 5400, 7450, 9500, 11650, 13650,
              15500, 17300, 19250]
    rrange67 = [2150, 4400, 6400, 8450, 10650, 12550, 14550,
              16350, 18200, 20350]

    ##emg_qing_68.csv  Broken data
    lrange68 = [1150, 3450, 5450, 7550, 9600, 11700, 13650,
              15550, 17300, 19350]
    rrange68 = [2150, 4400, 6450, 8500, 10700, 12650, 14550,
              16450, 18300, 20450]

    ##emg_qing_69.csv  Broken data
    lrange69 = [1150, 3450, 5500, 7550, 9550, 11650, 13650,
              15550, 17450, 19400]
    rrange69 = [2150, 4400, 6400, 8450, 10750, 12550, 14550,
              16450, 18400, 20400]

    ##emg_qing_70.csv  Broken data
    lrange70 = [1200, 3450, 5450, 7500, 9500, 11650, 13700,
              15500, 17350, 19300]
    rrange70 = [2150, 4400, 6450, 8450, 10700, 12600, 14600,
              16400, 18350, 20400]
    ...
    ## 提取数据 ##
    print "######## 提取数据部分 ########"
    rows = loaddata('emg_qing_{}.csv'.format(number))
    ...
    print locals()['lrange{}'.format(number)], locals()['rrange{}'.format(number)]
    time_seg, emg_seg = AllCutEmg(locals()['lrange{}'.format(number)], locals()['rrange{}'.format(number)], emg_after_denoise, cols[10])
    # time_seg, emg_seg = AllCutEmg(lrange21, rrange21, emg_after_denoise, cols[10])
   ...
   #  plt.show()
    ...
    # 绘制所有通道的图 ##
    # # Time_Domain #
    AllChannels(0, 0, cols[10], fs, emg_after_denoise, nfft, noverlap, number)
    AllChannels(1, 0, cols[10], fs, emg_after_denoise, nfft, noverlap, number)
    # Spectrum #
    AllChannels(0, 1, cols[10], fs, emg_after_denoise, nfft, noverlap, number)
    AllChannels(1, 1, cols[10], fs, emg_after_denoise, nfft, noverlap, number)
    # Spectrogram #
    AllChannels(0, 2, cols[10], fs, emg_after_denoise, nfft, noverlap, number)
    AllChannels(1, 2, cols[10], fs, emg_after_denoise, nfft, noverlap, number)

    # 绘制单个通道单个动作的图 ##
    # Time_domain #
    Single_Channel_Single_Action(0, 0, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)
    Single_Channel_Single_Action(1, 0, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)


    # Spectrum #
    Single_Channel_Single_Action(0, 1, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)
    Single_Channel_Single_Action(1, 1, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)
    # Spectrogram #
    Single_Channel_Single_Action(0, 2, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)
    Single_Channel_Single_Action(1, 2, action, num, t, time_seg, fs, emg_seg, nfft, noverlap, number)

    ## 绘制九个图在一个figures上 ##
    Nine_In_One_Ave(0, action, num, t, fs, emg_seg, nfft, noverlap, number)
    Nine_In_One_Ave(1, action, num, t, fs, emg_seg, nfft, noverlap, number)

    Nine_In_One_Max(0, action, num, t, fs, emg_seg, nfft, noverlap, number)
    Nine_In_One_Max(1, action, num, t, fs, emg_seg, nfft, noverlap, number)
