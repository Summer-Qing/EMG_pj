...
def main():
    ...
    ##emg_qing_130.csv  Broken data
    lrange130 = [1150, 3400, 5400, 7400, 9500, 11650, 13650,
              15400, 17350, 19250]
    rrange130 = [2200, 4400, 6450, 8500, 10700, 12600, 14550,
              16450, 18300, 20300]

    ##emg_qing_131.csv  Broken data
    lrange131 = [1150, 3400, 5400, 7450, 9450, 11650, 13650,
              15450, 17350, 19250]
    rrange131 = [2100, 4400, 6650, 8500, 10700, 12550, 14550,
              16450, 18300, 20300]

    ##emg_qing_132.csv  Broken data
    lrange132 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19200]
    rrange132 = [2050, 4400, 6450, 8500, 10700, 12550, 14550,
              16400, 18250, 20250]

    ##emg_qing_133.csv  Broken data
    lrange133 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17250, 19300]
    rrange133 = [2050, 4400, 6450, 8500, 10600, 12550, 14750,
              16400, 18250, 20250]

    ##emg_qing_134.csv  Broken data
    lrange134 = [1400, 3600, 5800, 7700, 9850, 11850, 13850,
              15600, 17550, 19550]
    rrange134 = [2250, 4500, 6650, 8700, 10900, 12800, 14700,
              16580, 18490, 20500]

    ##emg_qing_135.csv  Broken data
    lrange135 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19200]
    rrange135 = [2050, 4400, 6450, 8500, 10700, 12650, 14550,
              16400, 18250, 20250]

    ##emg_qing_136.csv  Broken data
    lrange136 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19300]
    rrange136 = [2150, 4400, 6400, 8500, 10700, 12550, 14550,
              16400, 18250, 20250]

    ##emg_qing_137.csv  Broken data
    lrange137 = [1300, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19250]
    rrange137 = [2250, 4500, 6450, 8350, 10750, 12600, 14550,
              16400, 18250, 20250]

    ##emg_qing_138.csv  Broken data
    lrange138 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19100]
    rrange138 = [2100, 4400, 6450, 8500, 10700, 12550, 14550,
              16400, 18250, 20250]

    ##emg_qing_139.csv  Broken data
    lrange139 = [1150, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19100]
    rrange139 = [2100, 4650, 6450, 8500, 10700, 12550, 14550,
              16500, 18250, 20250]

    ##emg_qing_140.csv  Broken data
    lrange140 = [1200, 3400, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19300]
    rrange140 = [2100, 4400, 6450, 8500, 10700, 12650, 14550,
              16400, 18250, 20250]

   # ##emg_qing_122.csv  Broken data
    lrange122 = [1150, 3300, 5400, 7450, 9450, 11650, 13650,
              15500, 17350, 19300]
    rrange122 = [2100, 4400, 6450, 8500, 10700, 12650, 14550,
              16400, 18250, 20250]

    # ##emg_qing_123.csv  Broken data
    lrange123 = [1200, 3300, 5400, 7350, 9350, 11600, 13650,
              15450, 17300, 19250]
    rrange123 = [2100, 4300, 6450, 8350, 10500, 12550, 14550,
              16400, 18250, 20250]


    # ##emg_qing_124.csv  Broken data
    lrange124 = [1150, 3300, 5400, 7450, 9450, 11650, 13550,
              15500, 17350, 19300]
    rrange124 = [2100, 4400, 6450, 8500, 10700, 12650, 14550,
              16400, 18250, 20250]

    # ##emg_qing_125.csv  Broken data
    lrange125 = [1050, 3300, 5200, 7250, 9250, 11650, 13550,
              15400, 17250, 19300]
    rrange125 = [2100, 4300, 6400, 8200, 10500, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_126.csv  Broken data
    lrange126 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange126 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_127.csv  Broken data
    lrange127 = [1150, 3300, 5350, 7450, 9250, 11650, 13550,
              15400, 17250, 19200]
    rrange127 = [2100, 4300, 6350, 8300, 10500, 12550, 14400,
              16300, 18150, 20150]

    # ##emg_qing_128.csv  Broken data
    lrange128 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange128 = [2100, 4300, 6450, 8400, 10600, 12750, 14450,
              16300, 18250, 20150]

    # ##emg_qing_129.csv  Broken data
    lrange129 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange129 = [2000, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_141.csv  Broken data
    lrange141 = [1150, 3200, 5200, 7350, 9350, 11650, 13550,
              15300, 17250, 19200]
    rrange141 = [2100, 4200, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_142.csv  Broken data
    lrange142 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19100]
    rrange142 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_143.csv  Broken data
    lrange143 = [1350, 3500, 5500, 7450, 9450, 11750, 13650,
              15500, 17350, 19200]
    rrange143 = [2100, 4400, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_144.csv  Broken data
    lrange144 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange144 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_145.csv  Broken data
    lrange145 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange145 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_146.csv  Broken data
    lrange146 = [1150, 3300, 5400, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange146 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_147.csv  Broken data
    lrange147 = [1150, 3300, 5300, 7350, 9350, 11550, 13550,
              15400, 17250, 19200]
    rrange147 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_148.csv  Broken data
    lrange148 = [1150, 3400, 5400, 7450, 9450, 11650, 13650,
              15600, 17350, 19300]
    rrange148 = [2100, 4500, 6350, 8400, 10600, 12550, 14550,
              16400, 18250, 20250]

    # ##emg_qing_149.csv  Broken data
    lrange149 = [1150, 3400, 5400, 7450, 9450, 11650, 13650,
              15600, 17350, 19300]
    rrange149 = [2100, 4500, 6350, 8400, 10600, 12550, 14550,
              16400, 18250, 20250]

    # ##emg_qing_150.csv  Broken data
    lrange150 = [1150, 3300, 5300, 7450, 9450, 11650, 13550,
              15400, 17250, 19200]
    rrange150 = [1900, 4300, 6300, 8400, 10600, 12550, 14450,
              16300, 18150, 20150]

    # ##emg_qing_151.csv  Broken data
    lrange151 = [1150, 3400, 5400, 7450, 9450, 11650, 13650,
              15400, 17250, 19100]
    rrange151 = [2100, 4500, 6350, 8400, 10600, 12550, 14550,
              16300, 18250, 20250]

    # ##emg_qing_152.csv  Broken data
    lrange152 = [1150, 3400, 5300, 7350, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange152 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_153.csv  Broken data
    lrange153 = [1150, 3300, 5300, 7350, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange153 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_154.csv  Broken data
    lrange154 = [1150, 3300, 5300, 7350, 9450, 11650, 13450,
              15400, 17250, 19100]
    rrange154 = [2100, 4300, 6100, 8400, 10600, 12550, 14450,
              16400, 18200, 20250]

    # ##emg_qing_155.csv  Broken data
    lrange155 = [1150, 3300, 5300, 7550, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange155 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_156.csv  Broken data
    lrange156 = [1150, 3300, 5300, 7350, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange156 = [2100, 4300, 6350, 8400, 10600, 12150, 14450,
              16400, 18250, 20250]

    # ##emg_qing_157.csv  Broken data
    lrange157 = [1150, 3300, 5300, 7350, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange157 = [2100, 4300, 6350, 8400, 10600, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_158.csv  Broken data
    lrange158 = [1150, 3300, 5300, 7350, 9450, 11650, 13450,
              15400, 17150, 19100]
    rrange158 = [2100, 4300, 6350, 8400, 10600, 12550, 14350,
              16400, 18250, 20250]

    # ##emg_qing_159.csv  Broken data
    lrange159 = [1150, 3300, 5350, 7350, 9450, 11650, 13500,
              15400, 17150, 19100]
    rrange159 = [2100, 4300, 6350, 8500, 10600, 12550, 14450,
              16400, 18250, 20250]

    # ##emg_qing_160.csv  Broken data
    lrange160 = [1450, 3600, 5700, 7650, 9550, 11850, 13750,
              15600, 17450, 19400]
    rrange160 = [2300, 4600, 6550, 8600, 10800, 12750, 14650,
              16450, 18450, 20450]

    # ##emg_qing_161.csv  Broken data
    lrange161 = [1350, 3400, 5300, 7450, 9450, 11750, 13650,
              15300, 17350, 19200]
    rrange161 = [2100, 4400, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_162.csv  Broken data
    lrange162 = [1350, 3400, 5400, 7450, 9450, 11550, 13650,
              15500, 17350, 19600]
    rrange162 = [2100, 4400, 6350, 8200, 10600, 12550, 14450,
              16350, 18250, 20350]

    # ##emg_qing_163.csv  Broken data
    lrange163 = [1150, 3200, 5200, 7150, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange163 = [2100, 4100, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_164.csv  Broken data
    lrange164 = [1150, 3200, 5300, 7250, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange164 = [2100, 4200, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_165.csv  Broken data
    lrange165 = [1150, 3200, 5200, 7250, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange165 = [2100, 4100, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20250]

    # ##emg_qing_166.csv  Broken data
    lrange166 = [1150, 3200, 5200, 7350, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange166 = [2100, 4150, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_167.csv  Broken data
    lrange167 = [1150, 3200, 5200, 7150, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange167 = [2100, 4100, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_168.csv  Broken data
    lrange168 = [1150, 3200, 5300, 7350, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange168 = [2000, 4100, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_169.csv  Broken data
    lrange169 = [1150, 3200, 5300, 7450, 9350, 11550, 13450,
              15300, 17350, 19100]
    rrange169 = [2100, 4100, 6350, 8400, 10500, 12550, 14550,
              16350, 18250, 20150]

    # ##emg_qing_170.csv  Broken data
    lrange170 = [1150, 3200, 5300, 7350, 9350, 11550, 13450,
              15300, 17150, 19200]
    rrange170 = [2100, 4100, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20150]

    # ##emg_qing_171.csv  Broken data
    lrange171 = [1350, 3400, 5400, 7450, 9450, 11750, 13650,
              15500, 17350, 19600]
    rrange171 = [2300, 4600, 6350, 8400, 10600, 12550, 14450,
              16350, 18250, 20350]
